...
normalized_data<-scale(iris[,1:4]) #excluding the Species columnbefore normalizing
...
acc_wbcd <- mean(iris$Species==predict(fit.forest,iris))
acc_wbcd   ###97.33% accuracy
