...
#line
ggplot(data=comp_test,aes(comp_test$speed+comp_test$hd+comp_test$ram+comp_test$screen+sqrt(comp_test$ads)+exp(comp_test$trend),comp_test$price))+stat_summary(fun.args = list(),fun.data = mean_cl_normal) +
  geom_smooth(method='lm')
