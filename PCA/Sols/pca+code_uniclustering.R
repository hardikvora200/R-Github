...
mydata<-read.csv("C:\\Users\\sanu\\Downloads\\Desktop\\Documents\\Excelr\\PCA\\Excelr sols\\Universities.csv") ## use read.csv for csv files
View(mydata)
...
?princomp
pcaObj<-prcomp(data, cor = TRUE, scores = TRUE, covmat = NULL)
